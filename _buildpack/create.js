...
async function createProjectFromVenia({ fs, tasks, options, sampleBackends }) {
    ...
    return {
        after({ options }) {
            // The storeofapp-concept directory doesn't have its own babel.config.js
        ...
        visitor: {
            ...
            'package.json': ({
                ...
                const pkg = {
                    ...
                    version: '0.0.1',
                    description:
                        'A new project based on @magento/storeofapp-concept',
                    author,
                    license: 'UNLICENSED',
                    scripts: {}
                };
                ...
                // The storeofapp-concept template is part of the monorepo, which
